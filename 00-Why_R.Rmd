...
One of the quickest ways to get help is to use the RStudio help interface. This
panel by default can be found at the lower right hand panel of RStudio. As seen in
the screenshot, by typing the word "Mean", RStudio tries to also give a number of
suggestions that you might be interested in. The description is then shown in the 
display window.
...
This will display the help topic in the Help pane on the lower right.
...
This will display the arguments of the function in the Console window.
