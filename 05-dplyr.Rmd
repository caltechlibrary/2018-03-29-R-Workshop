...
with **`dplyr`**. If you use RStudio, you can type the pipe with <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd>
on both PCs and Macs. (<kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> also works if you have a Mac.)
