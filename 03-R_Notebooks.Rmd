...
3. Add the line '## ---- math_trick' (without quotes) at the top of your file.
4. You can now call this R script in any R chunk in any R Notebook using the line `knitr::read_chunk("example.R")`.
